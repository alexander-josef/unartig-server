...
<div class="content_left496_middle">
    <div id="address_bill">
        <fieldset class="forms">
            <h3><bean:message bundle="CONTENT" key="address.bill"  /></h3>
            <table>
                <tr>
                ...
                <tr>
                    ...
                    <td><select name="countryMail" class="country_select"><option><bean:message bundle="CONTENT" key="country.switzerland"  /></option><!--plz 4 stellig-->
                        ...
                        <option><bean:message bundle="CONTENT" key="country.austria"  /></option><!--plz 4 stellig-->
                        <option><bean:message bundle="CONTENT" key="country.italy"  /></option><!--plz 5 stellig-->
                        <option><bean:message bundle="CONTENT" key="country.spain"  /></option><!--plz 5 stellig-->
