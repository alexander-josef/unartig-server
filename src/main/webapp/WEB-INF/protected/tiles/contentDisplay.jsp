            ...
            <c:if test="${ ! empty display.previousPhoto}">
                <ul id="preview_${display.previousPhoto.orientationSuffix}" class="preview">
                    <li class="preview_imageholder">
                        <html:link href="/display/${display.previousPhoto.photoId}/display.html" name="display" property="previousPhotoLinkParams" bundle="CONTENT" titleKey="photo.previous">
                            <html:img src="${display.previousPhoto.thumbnailUrl}" bundle="CONTENT" altKey="photo.previous"/>
                        </html:link>
                    </li>
                    <li>
                        <html:link href="/display/${display.previousPhoto.photoId}/display.html" name="display" property="previousPhotoLinkParams" bundle="CONTENT" titleKey="photo.previous">
                            ...
                            <tr>
                                ...
                                <td id="righthover">
                                    <c:if test="${display.nextPhoto !=null}">
                                        <html:link href="/display/${display.nextPhoto.photoId}/display.html" name="display" property="nextPhotoLinkParams" bundle="CONTENT" titleKey="photo.next">
                                            <img src="/images/display_hoverarea_${display.displayPhoto.orientationSuffix}.gif" alt=""/>
                                        </html:link>
                                    </c:if>
                                    <c:if test="${display.nextPhoto ==null}">
            ...
            <c:if test="${ ! empty display.nextPhoto}">
                <ul id="preview_${display.nextPhoto.orientationSuffix}" class="preview">
                    ...
                    <li class="preview_imageholder">
                        ...
                        <html:link href="/display/${display.nextPhoto.photoId}/display.html" name="display" property="nextPhotoLinkParams" bundle="CONTENT" titleKey="photo.next">
                            <html:img src="${display.nextPhoto.thumbnailUrl}" bundle="CONTENT" altKey="photo.next"/>
                        </html:link>
